...
<body>
    <nav class="navbar navbar-expand-md">
        <img src="https://drive.google.com/uc?export=download&id=1N-yj2KqeeyVd3t_RLgeaO2HGI5i94h4P" alt="logo3"
            width="100" height="50">
    ...
    <header class="page-header header container-fluid">
        <div class="description">
            ...
            <a class="btn btn-secondary dropdown-toggle btn-lg px-4" href="#" role="button" id="dropdownMenuLink"
