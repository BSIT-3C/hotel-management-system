   ...
   <main>
        <div class="container shadow-sm p-3 mb-5 bg-body rounded">
            <div class="row">
                ...
                <div class="row m-4">
                    <div class="col-6"><h2 class="fw-bolder">BLACKLIST FORM</h2></div>
                        <div class="row pt-3">
                            <span class="border-bottom border-dark border-1"></span>
                        </div>
                </div>
                
                <form action="/guestinfo/blacklist/store" method="POST">
                @csrf
                @method("PUT")
                    <div class="col-4 mx-auto mb-3">
                        <div class="mb-2">
                            <label for="guest_id">Guest ID</label>
                            <input type="number" class="form-control" name="guest_id" id="guest_id" required>
                        </div>
