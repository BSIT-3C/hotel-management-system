...
<body>
    ...
    <div class="container">
            ...
            <div class="row align-items-end my-5">
                <div class="col-5">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="/guestinfo/guest-form" class="link-primary mx-2 w-50">New guest?</a>
                    </div>
                </div>
                <div class="col-7">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="/guestinfo/reservation" class="link-primary mx-2 w-50">New reservation?</a>
                    </div>
                </div>
            </div>
        ...
        <button type="button" class="btn btn-primary float-end" id="notificationBtn">Confirm guest check-in</button>
        ...
        <div class="toast fixed-bottom m-5" id="notification" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="toast-header">
                ...
                <strong class="me-auto">Check-in</strong>
                <small>Just now</small>
                <button type="button" class="btn-close" data-bs-dismiss="toast" aria-label="Close"></button>
            </div>
            <div class="toast-body">
                Room 056 is now occupied.
            </div>
        </div>
        <script>
    ...
    <!-- 
        ...
        https://www.figma.com/file/SzLQTJT69tx8bSfZPiy15y/Front-Desk-Wireframe?node-id=447%3A97&t=tWufwCEg6ltF7z2s-0
     -->
