<section>
    <div class="quarternary d-flex justify-content-between align-items-center gap-2">
        ...
        <div class="d-flex align-items-center">
            <button class="btn bi bi-bell"></button>
            <div class="dropdown">
                <button class="btn bi bi-person-circle me-2" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"></button>
