...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        RoomType::factory()->count(4)->sequence(
            ['room_type' => 'Superior'], ['room_type' => 'Luxury'], 
            ['room_type' => 'Club Room'], ['room_type' => 'Suite'])
            ->create();

        // edit this accordingly
        Role::factory()->count(6)->sequence(
            ['role' => 'Receptionist'], ['role' => 'Accountant'], ['role' => 'House Keeper'], 
            ['role' => 'Admin'], ['role' => 'Front Desk'], ['role' => 'Manager'])
            ->create();
            
        PaymentMethod::factory()->count(3)->sequence(
            ['payment_method' => 'Cash'], ['payment_method' => 'Credit Card'], 
            ['payment_method' => 'Debit Card'], ['payment_method' => 'Paypal'],
            ['payment_method' => 'GCash'], ['payment_method' => 'Other'])
        ->create();
